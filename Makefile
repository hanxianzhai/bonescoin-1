...
# Generated by qmake (2.01a) (Qt 4.8.6) on: ?? 5? 1 15:40:42 2014
...
CXXFLAGS      = -m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -msse2 -w -O2 -fdiagnostics-show-option -Wall -Wextra -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector -D_REENTRANT $(DEFINES)
...
/home/xxx/git/communitycoin/build/build.h: FORCE
	cd /home/xxx/git/communitycoin; /bin/sh share/genbuild.sh /home/xxx/git/communitycoin/build/build.h
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/BonesCoin-16.png \
		src/qt/res/icons/BonesCoin-128.png \
