...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in BonesCoin
    bool fStrictPayToScriptHash = true; // Always active in BonesCoin
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "BSC to the Da Moon.";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1398916196;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 18780108;
 ...
 /*       block.print();
 	...
 	assert(block.hashMerkleRoot == uint256("a4575d0ab860cbb3f6b27a0bd15ec1e0d0b9731c568b3feccfc30ff593a9bb60"));
...
unsigned char pchMessageStart[4] = { 0xee, 0xfc, 0xfa, 0xdb };
